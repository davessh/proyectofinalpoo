...
public class TableroFiveCardDraw extends JFrame {
    ...
    // Rutas de imágenes
    public static final String RUTA_BASE_IMAGENES = "C:\\Users\\Usuario\\IdeaProjects\\proyectofinalpoo2\\Baraja\\";
    ...
    public static final String RUTA_IMAGEN_FONDO = "C:\\Users\\Usuario\\IdeaProjects\\proyectofinalpoo2\\MesaPoker.png"; // Ruta de imagen de fondo
    ...
    public class PanelJugador extends JPanel {
        ...
        public PanelJugador(Jugador jugador) {
            ...
            etiquetaNombre.setForeground(Color.WHITE); // Texto en negro
            ...
            etiquetaApuesta.setForeground(Color.WHITE);
            ...
            for (int i = 0; i < 5; i++) {
                ...
                etiquetasCartas[i].setPreferredSize(new Dimension(120, 120));
                ...
                botonesDescarte[i].setMaximumSize(new Dimension(200, 25));
    ...
    public TableroFiveCardDraw(int numJugadores) {
        ...
        etiquetaBote.setForeground(Color.WHITE);
    ...
    private String obtenerRutaImagenCarta(Carta carta) {
        ...
        switch (carta.rango) {
            case "A":
                rangoStr = "14";
                break; // As es 14 en este sistema de valores.
            case "J":
                rangoStr = "11";
                break;
            case "Q":
            ...
            case "K":
                ...
                break;
            default:
                rangoStr = carta.rango;
                break; // Para números, el rango es el mismo.
        }
